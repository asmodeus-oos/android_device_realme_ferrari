...
# Inherit VoltageOS common config
$(call inherit-product, vendor/voltage/config/common_full_phone.mk)

# Drop packages not supported on ferrari
PRODUCT_PACKAGES := $(filter-out \
    SystemUIClocks-Flex \
    com.google.android.webapp \
    ,$(PRODUCT_PACKAGES))

PRODUCT_NAME := voltage_ferrari
PRODUCT_DEVICE := ferrari
PRODUCT_MANUFACTURER := realme
PRODUCT_BRAND := realme
PRODUCT_MODEL := RMX3301

# Authorize the developer's Linux/WSL and Windows ADB public keys on userdebug builds
...
VOLTAGE_MAINTAINER := Asmodeus-OOS
PRODUCT_SYSTEM_DEFAULT_PROPERTIES += \
    ro.voltage.maintainer=Asmodeus-OOS
